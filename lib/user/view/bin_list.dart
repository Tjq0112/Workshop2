...
class _BinPage extends State<BinPage> {
  ...
  Future<void> _showDemandDialog(BuildContext context, Bin bin) async {
    return showDialog<void>(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text('Demand pickup?'),
          content: Text('Are you sure you want to demand a pickup for this bin?'),
          actions: <Widget>[
            TextButton(
              child: Text('Cancel'),
              onPressed: () {
